...
async function findFirstSender(buyerAddress: string): Promise<string | undefined> {
...
function checkRelationship(buyer: string, seller: string): Finding[] { 
  const results: Finding[] = [] 

  findFirstSender(buyer).then((sender) => {
    if ((sender) == seller) {
